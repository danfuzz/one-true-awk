...
#if VMS		/* work around nasty size limit for VMSHELPtiONFI.awk  */
#define	RECSIZE	(3 * 40960)	/* sets limit on records, fields, etc., etc. */
#else
...
extern Cell	*rstloc;	/* RSTART */
extern Cell	*rlnloc;	/* RLENGTH */
