...
break;
case 14:
	{ yylval = MATCH; RET(MATCHOP); }
break;
case 15:
	{ yylval = NOTMATCH; RET(MATCHOP); }
break;
case 16:
	{ yylval = LT; RET(LT); }
break;
...
break;
case 21:
	{ yylval = APPEND; RET(APPEND); }
break;
case 22:
	{ yylval = INCR; RET(INCR); }
break;
case 23:
	{ yylval = DECR; RET(DECR); }
break;
case 24:
	{ yylval = ADDEQ; RET(ASGNOP); }
break;
case 25:
	{ yylval = SUBEQ; RET(ASGNOP); }
break;
case 26:
	{ yylval = MULTEQ; RET(ASGNOP); }
break;
case 27:
	{ yylval = DIVEQ; RET(ASGNOP); }
break;
case 28:
	{ yylval = MODEQ; RET(ASGNOP); }
break;
case 29:
	{ yylval = POWEQ; RET(ASGNOP); }
break;
case 30:
{ yylval = POWEQ; RET(ASGNOP); }
break;
case 31:
	{ yylval = ASSIGN; RET(ASGNOP); }
break;
case 32:
	{ RET(POWER); }
break;
...
break;
case 34:
{ yylval = (int) fieldadr(atoi(yytext+1)); RET(FIELD); }
break;
case 35:
...
{ int c, n;
		  ...
		  if (c == '(' || c == '[' || infunc && (n=isarg(yytext+1)) >= 0) {
			...
			yylval = (int)setsymtab(yytext+1,"",0.0,STR|NUM,symtab);
			RET(IVAR);
		  }
		}
break;
...
break;
case 38:
	{ yylval = (int)setsymtab(yytext, "", 0.0, NUM, symtab); RET(VARNF); }
break;
case 39:
{
...
break;
case 49:
{ yylval = PRINT; RET(PRINT); }
break;
case 50:
{ yylval = PRINTF; RET(PRINTF); }
break;
case 51:
{ yylval = SPRINTF; RET(SPRINTF); }
break;
case 52:
{ yylval = SPLIT; RET(SPLIT); }
break;
case 53:
{ RET(SUBSTR); }
break;
...
break;
case 62:
{ yylval = FLENGTH; RET(BLTIN); }
break;
case 63:
	{ yylval = FLOG; RET(BLTIN); }
break;
case 64:
	{ yylval = FINT; RET(BLTIN); }
break;
case 65:
	{ yylval = FEXP; RET(BLTIN); }
break;
case 66:
	{ yylval = FSQRT; RET(BLTIN); }
break;
case 67:
	{ yylval = FSIN; RET(BLTIN); }
break;
case 68:
	{ yylval = FCOS; RET(BLTIN); }
break;
case 69:
{ yylval = FATAN; RET(BLTIN); }
break;
case 70:
{ yylval = FSYSTEM; RET(BLTIN); }
break;
case 71:
	{ yylval = FRAND; RET(BLTIN); }
break;
case 72:
{ yylval = FSRAND; RET(BLTIN); }
break;
case 73:
{ int n, c;
...
# ifdef LEXDEBUG
				if(debug){
					fprintf(yyout,"\nmatch ");
#ifndef tops20	/* collides with sprintf */
					sprint(yytext);
#else
					lprint(yytext);
#endif
