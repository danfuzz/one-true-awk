...
1 2 3 4 5
1    ' >foo1
$awk ' { NF = 5 ; print } ' foo >foo2
cmp -s foo1 foo2 || ./echo 'BAD: T.gawk nfset.  awk just differs'
...
# funstack:
./echo funstack test takes 5-10 sec
# time $awk -f funstack.awk funstack.in >foo 2>&1
